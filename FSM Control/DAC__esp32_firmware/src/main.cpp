...
// Flask server URL
const char *serverUrl = "http://****/data"; // Replace with your server's IP and port
...
{
  HTTPClient http;
  http.begin("http://****/getdata"); // Flask server providing data
  ...
  if (httpCode > 0)
  {
    ...
    http.begin("http://****/data"); // Flask server receiving data
